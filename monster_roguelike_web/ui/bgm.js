...
export const TRACKS = {
  ...
  hub: {
    name: '拠点 — ギルドの朝',
    screens: ['screen-hub','screen-name','screen-starter-event','screen-egg','screen-tutorial-select'],
    bpm: 104,
    melody: [
      // 小節1: G Dorian上昇 (G A Bb C D E F)
