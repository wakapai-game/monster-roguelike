...
<div class="help-section">
  ...
  <p class="help-p">バトルは <b>ATB（Active Time Battle）</b> 方式です。各ジュウマの <b>スピード(SPD)</b> に応じてゲージが自動で溜まり、ゲージが 100 に達したときにそのジュウマが行動します。</p>
  <p class="help-p">自分のジュウマがゲージ満タン → <b>攻撃フェーズ</b>（スキルを選んで攻撃）<br>
  敵のジュウマがゲージ満タン → <b>防御フェーズ</b>（敵の攻撃に対応）</p>
</div>

<div class="help-section">
  <h3 class="help-h3">📋 ACTION QUEUE（行動キュー）</h3>
  <p class="help-p">中央パネルの <b>ACTION QUEUE</b> には、次に行動するジュウマの順番が最大 6 ターン先まで表示されます。一番上が「次に行動するジュウマ」です。</p>
...
<div class="help-section">
  ...
  <ul class="help-list">
    ...
    <li><b>控えと交代</b>：任意のタイミングで控えのジュウマに交代できる（交代後は ATB ループが再スタート）</li>
  </ul>
</div>
...
<div class="help-section">
  ...
  <ul class="help-list">
    ...
    <li><b>控えと交代</b>：控えのジュウマに交代。交代したジュウマが敵の攻撃を受ける</li>
  </ul>
</div>
...
<div class="help-section">
  ...
  <ul class="help-list">
    <li><b>勝利</b>：敵チームのジュウマを全員倒す → リワード（報酬）獲得</li>
    <li><b>敗北</b>：自パーティのジュウマが全員HP0 → <span style="color:#ef4444;">ゲームリセット（リロード）</span>。セーブデータがあれば再開可能</li>
  </ul>
</div>

<div class="help-section">
  <h3 class="help-h3">🏆 ステージクリアと卵</h3>
  <p class="help-p">ステージ最終フロアのボスを倒すとステージクリア。報酬画面の後に <b>卵選択画面</b> に移り、新しいジュウマを1体仲間にできます。ステージクリアで次のステージが解放されます。</p>
</div>
`;
}
...
<div class="help-section">
  ...
  <p class="help-p">ST はジュウマの <b>スタミナ兼防御壁</b> です。ST が高いほどスキルの威力が HP に届きにくくなります。</p>
  <p class="help-p">自分のジュウマの ST は画面左の黄色バーで確認できます。<b>敵の ST は表示されません</b>。攻撃を続けて ST を削り、HP へのダメージを通しましょう。</p>
</div>
...
<div class="help-section">
  ...
  <p class="help-p">バトル中、控えに下がっているジュウマは <b>1行動ごとに最大STの5%</b> を自動回復します。ST が減ったジュウマを控えに下げてSTを回復させましょう。</p>
</div>
...
<div class="help-section">
  ...
  <ul class="help-list">
    ...
    <li>ジュウマはメイン属性とサブ属性を持つ。スキル属性が両方に有利なら×4（ブレイク時×8）</li>
  </ul>
</div>
`;
}
