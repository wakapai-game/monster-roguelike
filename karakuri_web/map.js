export class TutorialMapGenerator {
  constructor() {
    ...
    this.nodes = [
      ...
      { id: 'f3_n0', floor: 3, x: 0.5, type: 'event_stat',  next: ['f4_n0'], state: 'hidden'    },
      { id: 'f4_n0', floor: 4, x: 0.5, type: 'battle',      next: ['f5_n0'], state: 'hidden'    },
      { id: 'f5_n0', floor: 5, x: 0.5, type: 'boss',        next: [],        state: 'hidden'    },
    ];
  }
  generate() {}
