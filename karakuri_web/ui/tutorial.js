...
const STEPS_CASE3 = {
  ...
  'attack-phase': {
    title: '攻撃フェーズ',
    full: 'コルク：「スキルを選んで攻撃しろ。敵の EN（エナジー）を削るんだ。\n\nENはカラクリの装甲みたいなもんで、残ってるとダメージのほとんどがENに吸われる。ENが低くなるほどHPへのダメージが「溢れ」やすくなる。\n\nとにかくスキルを選んでみろ。」',
    simple: '💡 スキルで敵ENを削ろう！ENが低いほどHPへのダメージが溢れやすくなります！',
  ...
  'swap': {
    title: '控えと交代する',
    full: 'コルク：「「カラクリ交代」で交代できる。\n\nENが減ったやつを下げて、元気なやつと代われ。控えに回ったカラクリはENが少し自動回復する。\n\n攻撃でも防御でも交代できる。使いこなせ。」',
    simple: '💡 「カラクリ交代」でいつでも交代！控えのカラクリはENが自動回復します。',
    highlight: 'swap-wrapper'
  },
  'affinity': {
    title: '属性相性',
    full: 'コルク：「スキルボタンの「バツグン」バッジを見ろ。\n\nバツグン属性のスキルはENダメージも、HPへの溢れも両方増える。\n\n右下の「属性」ボタンで相性表をいつでも確認できる。敵の属性に合わせて選べ。それだけで全然違う。」',
    simple: '💡 バツグン属性のスキルはEN削り＆HP溢れダメージ両方アップ！右下「属性」で確認！',
    highlight: 'skill-buttons'
  },
  'reward': {
    title: '戦利品',
