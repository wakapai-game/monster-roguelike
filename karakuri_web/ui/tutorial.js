...
const STEPS_CASE3 = {
  ...
  'pre-battle-boss': {
    title: 'ENを管理しろ',
    full: 'コルク：「ボス戦だ。相手はENを大きく削ってくる。\n\nお前のENが尽きるとギアが強制的に吹き飛ぶ（オートパージ）。\n\n攻撃フェーズの「パージ」ボタンから自分でギアを外して、先にENを回復する手もある。全部使え。」',
    simple: '💡 ENが切れると強制パージ！攻撃フェーズで任意パージもできる。',
    highlight: null
  },
  'stat-parts-intro': {
    title: 'ステータスボディギア',
    full: 'コルク：「ボディギアをガタに組み込んだ。ボーナスがある代わりにデメリットもある。\n\nHPが増えてもSPDが落ちる、ATKが上がるがDEFが下がる。そういうもんだ。\n\nパーティを開いてガタのステータス変化を確認しろ。」',
    simple: '💡 ボディギアはパーティ画面で確認できます！ボーナスとデメリットがセットです。',
    highlight: null
  },
  'purge-intro': {
    title: 'パージとは',
    full: 'コルク：「「パージ」ボタンが出てる。攻撃フェーズ中に任意のギアを外せる。\n\nギアを捨てると引き換えにENが回復する。ENが尽きそうなときの保険だ。\n\n一度外したギアは戻らない。考えて使え。」',
    simple: '💡 パージでギアを外してEN回復。ENが切れる前に使おう。',
    highlight: null
  },
  'pre-battle': {
    title: 'チュートリアル戦闘',
  ...
  'reward': {
    title: '戦利品',
    full: 'コルク：「勝ったな。3つ報酬が出る。1つもらえ。\n\n⚙️ ワザギア → インベントリに追加。パーティ画面でビルガマタに装備できる\n💊 バトル用アイテム → 次のバトルで使える\n🔩 ボディギア → ビルガマタのステータスをアップ\n\nビルガマタが増えたら、控えとの交代も使えるようになる。問題ない。」',
