...
const SLIDES = [
  {
    tag: 'このゲームとは',
    headline: '地上へ、もう一度。',
    body: '地下に眠るモンスター「ジュウマ」と契約し、荒廃した地上を取り戻す——。プレイヤーはビルガウィーラーとして、ダンジョンを踏破していく。',
    visual: 'world',
  },
  {
    tag: '育成とは',
...
function _updateDots() {
  ...
  document.dispatchEvent(new CustomEvent('pres-slide-change', { detail: { index: _currentSlide } }));
}
