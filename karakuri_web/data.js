...
const TUTORIAL_JUMA = {
  id: "j_tutorial", name: "おためしジュウマ",
  main_element: "ice", sub_element: "none",
  base_stats: { hp: 3000, atk: 12, def: 45, mag: 55, spd: 8, max_en: 100, en_rec: 0 },
...
const TUTORIAL_BOSS_JUMA = {
  ...
  main_element: "ice", sub_element: "none",
  base_stats: { hp: 2400, atk: 28, def: 15, mag: 35, spd: 22, max_en: 120, en_rec: 8 },
  tech: ["tp_strike", "tp_ice_shot", "tp_slow"], drop: null
};
...
export {
  ...
  KARAKURI_DATA, JUMA_DATA, TUTORIAL_JUMA,
